...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioPlay",
        function () awful.spawn("musicctl toggle") end,
        {description = "Play/Pause media playback", group = functions_group}),
    awful.key({}, "XF86AudioPrev",
        function () awful.spawn("musicctl previous") end,
        {description = "Previous song", group = functions_group}),
    awful.key({}, "XF86AudioNext",
        function () awful.spawn("musicctl next") end,
        {description = "Next song", group = functions_group}),
    awful.key({}, "XF86AudioStop",
        function () awful.spawn("musicctl stop") end,
