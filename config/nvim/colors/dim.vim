...
if &background == "light"
  ...
  highlight SpellBad     ctermfg=9                 cterm=underline,italic
  highlight SpellLocal   ctermfg=13                cterm=italic
  highlight SpellCap     ctermfg=12                cterm=underline,italic 
